...
Type "help", "copyright", "credits" or "license()" for more information.
{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "# loading dataset\n",
    "df=credit_card_data = pd.read_csv('creditcard.csv')"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "54091    46283.0  1.125412 -2.115312  1.114173 -0.844366 -2.342197  0.603994   \n",
       "198838  132673.0  1.663849 -1.579413 -2.964071 -1.339059 -0.093108 -1.468842   \n",
       "177278  123111.0 -0.612184  0.448063 -1.127889 -1.722061  3.174113  3.429686   \n",
       "250225  154791.0 -0.386745  0.545255 -0.358309 -0.632553  1.106687 -0.761478   \n",
       "117187   74574.0 -0.974205  1.582140  0.536607  1.712919  0.763378 -0.320759   \n",
       "\n",
       "              V7        V8        V9  ...       V21       V22       V23  \\\n",
       "54091  -1.747204  0.377609 -0.401041  ... -0.373552 -0.668160 -0.092627   \n",
       "198838  0.891837 -0.689338 -0.983461  ...  0.120934  0.298877 -0.435657   \n",
       "177278  0.573216  0.927708 -0.097334  ... -0.141726 -0.511660 -0.059310   \n",
       "250225  1.022862 -0.093116  0.342110  ... -0.143535 -0.404261 -0.022533   \n",
       "117187  0.865200  0.257930 -1.672513  ...  0.086002 -0.048867 -0.325944   \n",
       "\n",
       "             V24       V25       V26       V27       V28  Amount  Class  \n",
       "54091  -0.032614  0.264979 -0.216459  0.055207  0.035661  151.50      0  \n",
       "198838 -0.218859  0.421497  1.038760 -0.185927 -0.053428  324.40      0  \n",
       "177278  0.576353  0.135296 -0.068839  0.098811  0.156127   68.33      0  \n",
       "250225 -0.930927 -0.389245 -0.126889  0.151765  0.221536   62.88      0  \n",
       "117187 -0.470364  0.302443  0.062506 -0.204068  0.030063   21.19      0  \n",
       "\n",
       "[5 rows x 31 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "               Time        V1        V2        V3        V4        V5  \\\n",
       "Class                                                                   \n",
       "0      94866.123984 -0.031682 -0.054745  0.033987  0.025707  0.031542   \n",
       "1      80746.806911 -4.771948  3.623778 -7.033281  4.542029 -3.151225   \n",
       "\n",
       "             V6        V7        V8        V9  ...       V20       V21  \\\n",
       "Class                                          ...                       \n",
       "0     -0.025000 -0.002063  0.029870  0.043778  ... -0.001637  0.023643   \n",
       "1     -1.397737 -5.568731  0.570636 -2.581123  ...  0.372319  0.713588   \n",
       "\n",
       "            V22       V23      V24       V25       V26       V27       V28  \\\n",
       "Class                                                                        \n",
       "0      0.020206  0.029242 -0.01856 -0.032762  0.011378  0.010081 -0.000337   \n",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "54091  -1.747204  0.377609 -0.401041  ... -0.188510 -0.373552 -0.668160   \n",
      "198838  0.891837 -0.689338 -0.983461  ...  0.056603  0.120934  0.298877   \n",
      "177278  0.573216  0.927708 -0.097334  ...  0.149255 -0.141726 -0.511660   \n",
      "250225  1.022862 -0.093116  0.342110  ...  0.034745 -0.143535 -0.404261   \n",
      "117187  0.865200  0.257930 -1.672513  ... -0.189461  0.086002 -0.048867   \n",
      "...          ...       ...       ...  ...       ...       ...       ...   \n",
      ...
      "\n",
      "             V23       V24       V25       V26       V27       V28  Amount  \n",
      "54091  -0.092627 -0.032614  0.264979 -0.216459  0.055207  0.035661  151.50  \n",
      "198838 -0.435657 -0.218859  0.421497  1.038760 -0.185927 -0.053428  324.40  \n",
      "177278 -0.059310  0.576353  0.135296 -0.068839  0.098811  0.156127   68.33  \n",
      "250225 -0.022533 -0.930927 -0.389245 -0.126889  0.151765  0.221536   62.88  \n",
      "117187 -0.325944 -0.470364  0.302443  0.062506 -0.204068  0.030063   21.19  \n",
      "...          ...       ...       ...       ...       ...       ...     ...  \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "tra_data_acc = accuracy_score(X_train_prediction, Y_train)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Accuracy Training data :  0.9110546378653113\n"
     ]
    }
   ],
   "source": [
    "print('Accuracy Training data : ', tra_data_acc)"
   ]
  },
  {
   "cell_type": "code",
